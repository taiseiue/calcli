...
public class ExpressionParser
{
    ...
    public int Primary(Token<ExpressionToken> intToken) => intToken.IntValue;

    [NodeName("group")]
    [Production("primary: LPAREN [d] expression RPAREN [d]")]
    public int Group(int groupValue) => groupValue;
    ...
    public int Expression_Term(int termValue) => termValue;
    ...
    [NodeName("term")]
    public int Term_Factor(int factorValue) => factorValue;

    [Production("factor : primary")]
    [NodeName("primary")]
    public int primaryFactor(int primValue) => primValue;

    [NodeName("negate")]
    [Production("factor : MINUS factor")]
    public int Factor(Token<ExpressionToken> discardedMinus, int factorValue) => -factorValue;
}